      ...
      <div class='panel-body'>
        <form action="application" class='form-horizontal' role='form'>
          <div class='form-group'>
            ...
            <div class='col-md-2'>
              <select class='form-control' id='id_accomodation' name="custom_sections" value="<%= request.getAttribute("CustomSections") %>">
                <option>Yes</option>
                <option>No</option>
          ...
          <div class='form-group'>
            ...
            <div class='col-md-8'>
              <div class='col-md-3 indent-small'>
                <div class='form-group internal'>
                  <input class='form-control' id='id_Custom_Question_1' value="<%= request.getAttribute("CustomQuestion1") %>" name=custom_question_1 type='text'>
                </div>
              </div>
              <div class='col-md-3 indent-small'>
                <div class='form-group internal'>
                  <input class='form-control' id='id_Custom_Question_2' value="<%= request.getAttribute("CustomQuestion2") %>" name=custom_question_2 type='text'>
                </div>
              </div>
              <div class='col-md-3 indent-small'>
                <div class='form-group internal'>
                  <input class='form-control' id='id_Custom_Question_3' value="<%= request.getAttribute("CustomQuestion3") %>" name=custom_question_3 type='text'>
                </div>
              </div>
              <div class='col-md-3 indent-small'>
                <div class='form-group internal'>
                  <input class='form-control' id='id_Custom_Question_4' value="<%= request.getAttribute("CustomQuestion4") %>" name=custom_question_4 type='text'>
                </div>
              </div>
              <div class='col-md-3 indent-small'>
                <div class='form-group internal'>
                  <input class='form-control' id='id_Custom_Question_5' value="<%= request.getAttribute("CustomQuestion5") %>" name=custom_question_5 type='text'>
                </div>
              </div>
            </div>
          </div>   <div class='form-group'>
            <div class='col-md-offset-4 col-md-3'>
              <button class='btn-lg btn-primary' type='submit' name='application' value="<%= request.getAttribute("Dept_ID") %>">Edit Application</button>
            </div>
            <div class='col-md-3'>
